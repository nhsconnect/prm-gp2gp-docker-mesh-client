...
from gp2gpmi.meshinboxscanner import MeshInboxScanner
...
def test_finds_file_in_directory(fs):
    ...
    fs.create_file(ctrl_file_path, contents='<DTSControl><StatusRecord><DateTime>20201025030139</DateTime></StatusRecord></DTSControl>')
